	...
	<div class="row">
		<div class="container-flexible bnb-border mb-2 p-5 text-center">
			...
			<p class="form-description-raleway" style="color:white; background:#26578C; border-radius:10px;">	
				<b><small>RuPay cards are issued over the counter at any of our branches/ extension offices. If you are in Bhutan, please visit one of our branch/ extension offices to apply for & collect one - it will be faster than applying online.</small></b>	
			</p>
		</div>		
	</div>
