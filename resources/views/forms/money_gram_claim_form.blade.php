...
<form  method="POST" action="{{route('submit_money_gram_claim_form')}}" enctype="multipart/form-data">
   @csrf
   <div class="row">
      <div class="container-flexible bnb-border mb-3 px-5 py-1 form-description">
         <div class="container-flexible bnb-border mb-2">
            <h3 class="form-title text-center">MoneyGram Claim Form</h3>
            @if(!blank(session('code')))
            <h4 class="bnb-error">{{ session('code') }}</h4>
            @endif
            <div class= "row column mb-0 pt-3 px-4 mx-0">
         ...
         <h6 class="text-bnb-b">Receiver Details</h6>
         ...
         <div class="row">
            ...
            <div class="col-md-3 mb-3">
               ...
               <small class="input-description">Please enter your complete name in the order: First Name, Middle Name, Surname</small>
               @error('Name')
               <br>
               <span class="bnb-error m-auto">
               <small><strong>{{$message}}</strong></small>
            ...
            <div class="container ml-3 mr-3 p-3 mb-3 border">
               <div class="row">
                  <div class="col-md-6">
         ...
         <h6 class="text-bnb-b mt-4">Bank Details</h6>
         ...
         <h6 class="text-bnb-b">Sender/ Remitter</h6>
         ...
         <h6 class="text-bnb-b">Confirmation about the claim of Incentive</h6>
