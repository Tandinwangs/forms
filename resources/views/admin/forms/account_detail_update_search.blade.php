	...
	<div class="row">
		<div class="container-flexible bnb-border mb-2 p-5 form-description">
			<div class="row">
				...
				<div class="col-sm-3">
					<a href="{{ route('account_detail_update_forms_path') }}" class="btn btn-sm btn-primary btn-block">Back to Account Detail Update Forms</a>
					@if(isset($forms))
			...
			<div class="collapse {{!isset($forms)?'show':''}}" id="expand">
				...
				<form method="GET" action="{{route('search_account_detail_update_forms_path')}}">
					<div class="row mb-3">
