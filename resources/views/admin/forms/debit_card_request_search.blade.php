	...
	<div class="row">
		<div class="container-flexible bnb-border mb-2 p-5 form-description">
			<div class="row">
				...
				<div class="col-sm-3">
					<a href="{{ route('debit_card_request_forms_path') }}" class="btn btn-sm btn-primary btn-block">Back to Debit Card Request Forms</a>
					@if(isset($forms))
			...
			<div class="collapse {{!isset($forms)?'show':''}}" id="expand">
				...
				<form method="GET" action="{{route('search_debit_card_request_forms_path')}}">
					<div class="row mb-3">
						...
						<div class="col-md-4 mb-3">
							<label for="CIDNUmber">CID Number :</label>
							<input type="text" name="CIDNUmber" id="CIDNUmber" class="form-control" placeholder="Customer CID Number">
						</div>
					</div>
					<div class="row">
				    	...
				    	@foreach($forms as $f)
						    <tr>
						        ...
						        <td class="text-center">
						        	<div class="btn-group">
						        		<a href="{{route('show_debit_card_request_form_path',[$f->id,'search-show','name'=>$name,'account'=>$account,'mobile'=>$mobile,'cidnumber'=>$cidnumber,'code'=>$code])}}" class="btn btn-primary btn-sm"><small>View</small></a>
