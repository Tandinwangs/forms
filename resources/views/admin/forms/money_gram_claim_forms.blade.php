	...
	<div class="row">
		<div class="container-flexible bnb-border mb-2 p-5 form-description">
			<div class="row">
				...
				<div class="col-sm-3">
					<a href="{{ route('search_money_gram_claim_form_path') }}" class="btn btn-sm btn-primary btn-block">Advance Search Options</a>
				</div>
			</div>
			<hr>
				    	...
				    	@foreach($forms as $f)
						    <tr>
						        ...
						        <td class="text-center">
						        	<div class="btn-group">
						        		<a href="{{route('show_money_gram_claim_form_path',[$f->id,'show'])}}" class="btn btn-primary btn-sm"><small>View</small></a>
						        	</div>
						        </td>
						    </tr>
					    @endforeach
